  ...
  entries: [
    {
      ...
      clockDisplay: "12'",
      type: "GOAL",
      home: { id: "usa", fifaCode: "USA", flagEmoji: "🇺🇸", flagAlt: "United States flag", name: "United States", shortName: "USA" },
      away: { id: "mex", fifaCode: "MEX", flagEmoji: "🇲🇽", flagAlt: "Mexico flag", name: "Mexico", shortName: "MEX" },
    ...
    },
    {
      ...
      clockDisplay: "HT",
      type: "HALF_TIME",
      home: { id: "arg", fifaCode: "ARG", flagEmoji: "🇦🇷", flagAlt: "Argentina flag", name: "Argentina", shortName: "ARG" },
      away: { id: "bra", fifaCode: "BRA", flagEmoji: "🇧🇷", flagAlt: "Brazil flag", name: "Brazil", shortName: "BRA" },
