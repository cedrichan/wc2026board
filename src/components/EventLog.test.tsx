  ...
  entries: [
    {
      ...
      clockDisplay: "12'",
      type: "GOAL",
      home: { fifaCode: "USA", flagEmoji: "🇺🇸", name: "United States", shortName: "USA" },
      away: { fifaCode: "MEX", flagEmoji: "🇲🇽", name: "Mexico", shortName: "MEX" },
    ...
    },
    {
      ...
      clockDisplay: "HT",
      type: "HALF_TIME",
      home: { fifaCode: "ARG", flagEmoji: "🇦🇷", name: "Argentina", shortName: "ARG" },
      away: { fifaCode: "BRA", flagEmoji: "🇧🇷", name: "Brazil", shortName: "BRA" },
